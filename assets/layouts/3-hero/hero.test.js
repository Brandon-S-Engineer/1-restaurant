...
describe('Hero Slider Functionality', () => {
  ...
  test('slider auto-updates after interval', () => {
    ...
    // Simulate load event to start autoSlide
    window.dispatchEvent(new Event('load'));

    console.log('Before timers:', document.querySelector('.slider-item.active').outerHTML);

    jest.advanceTimersByTime(7000);

    console.log('After timers:', document.querySelector('.slider-item.active').outerHTML);
